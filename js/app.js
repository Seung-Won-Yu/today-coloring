...
function ColoringScreen({ art, fills, selected, onSelect, onPaint, onExit, onFinish, tweaks, onProgressChange }) {
  ...
  ), layout === "bottom" && /* @__PURE__ */ React.createElement("div", { className: "color-toolbelt", style: { zIndex: 18 } }, /* @__PURE__ */ React.createElement("button", { className: "color-toolbelt__btn", onClick: handleUndo, disabled: !hasHistory, "aria-label": "\uB418\uB3CC\uB9AC\uAE30" }, /* @__PURE__ */ React.createElement(Icon, { name: "undo", size: 22 })), /* @__PURE__ */ React.createElement("button", { className: "color-toolbelt__btn", onClick: handleReset, "aria-label": "\uCD08\uAE30\uD654" }, /* @__PURE__ */ React.createElement(Icon, { name: "trash", size: 22 })), /* @__PURE__ */ React.createElement("button", { className: "color-toolbelt__btn", onClick: toggleZoom, "aria-label": "\uB3CB\uBCF4\uAE30 \uD1A0\uAE00" }, /* @__PURE__ */ React.createElement(Icon, { name: "zoom", size: 22 }))), /* @__PURE__ */ React.createElement("div", { className: "palettezone palettezone--" + layout, style: { zIndex: 20 } }, /* @__PURE__ */ React.createElement("div", { className: "curcolor", style: { background: selected, borderColor: isLight(selected) ? "rgba(74,64,54,.3)" : "transparent" } }, /* @__PURE__ */ React.createElement("span", { className: "curcolor__label", style: { color: isLight(selected) ? "#4A4036" : "#fff" } }, "\uD604\uC7AC \uC0C9"), /* @__PURE__ */ React.createElement("span", { className: "curcolor__name", style: { color: isLight(selected) ? "#4A4036" : "#fff", fontSize: "13px", fontWeight: "bold", marginTop: "2px" } }, PALETTE.find((p) => p.c === selected)?.name || "")), /* @__PURE__ */ React.createElement(Palette, { selected, onSelect, layout, swatchSize: tweaks.swatchSize || 60 }))));
}
